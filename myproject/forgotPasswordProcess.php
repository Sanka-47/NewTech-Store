...
if(isset($_GET["e"])){
    ...
    if($n==1){
        ...
        $mail =new PHPMailer;
            ...
            $mail->SMTPSecure = 'ssl';
            $mail->Port = 465;
            $mail->setFrom('sankakonara69@gmail.com', 'Reset Password');
            $mail->addReplyTo('sankakonara69@gmail.com', 'Reset Password');
            $mail->addAddress($email);
            $mail->isHTML(true);
            $mail->Subject = 'New Tech Forgot Password Verification Code';
