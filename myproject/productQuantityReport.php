                ...
                <div class="collapse navbar-collapse" id="navbarsFurni">
                    <ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
                        ...
                        <div class="me-4 mb-sm-1">
                            <button class="btn" style="background-color: white;border:none;" onclick="sortChange();"><img src="resources\product-icon\search.svg" style="height: 25px;" class="img-fluid"></a></button>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 text-center mb-3 mt-4">
                    <h2 class="h2 text-primary fw-bold">Low Quantity Products</h2>
                </div>
                            ...
                            <div class="row">
                                <div class="col-12 mt-3 fs-5">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-12">
                                            <label class="form-label fw-bold fs-3">Search Products</label>
                                        </div>
                                        <div class="col-11">
                                            <div class="row">
                                                <div class="col-10">
                                                    <input type="text" placeholder="Product Name..." class="form-control" id="s" />
                                                </div>
                                                <div class="col-2 d-grid">
                                                    <button class="btn btn-success fw-bold" onclick="Reportsort(0);">Search</button>
                                                </div>
                            ...
                            <div class="row" id="sort">
                                ...
                                <div class="offset-1 col-10 text-center">
                                    <div class="row justify-content-center">
                                        ...
                                        $product_rs = Database::search("SELECT * FROM `product` WHERE `qty`<='5' AND `users_email`='" . $email . "' ORDER BY `qty` ASC");
                                        ...
                                        $selected_rs = Database::search("SELECT * FROM `product` WHERE `qty`<='5' AND `users_email`='" . $email . "' ORDER BY `qty` ASC
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="card-body">
                                                                ...
                                                                <span class="card-text fw-bold text-danger"><?php echo $selected_data["qty"]; ?> Items left</span>
